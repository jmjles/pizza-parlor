...
const Modal = (props: ModalType) => {
    ...
    return (
        ...
        >
            <Container style={{ textAlign: 'right',display:props.disableCloseButton ? "none":"" }} disableGutters>
                <IconButton color="error" onClick={props.handleClose}>
                    <Close />
                </IconButton>
            </Container>
            <DialogTitle align="center" variant="h3" sx={{ paddingTop:props.disableCloseButton ? "" : '0px' }}>
                {props.title}
            </DialogTitle>
